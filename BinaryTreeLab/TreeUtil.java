...
public class TreeUtil
{
    ...
    public static int eval(TreeNode expTree)
    {
        ...
        if(expTree != null)
        {
            if(!isOperator((Character)expTree.getValue()))
            {
                return ((Character) expTree.getValue()) - '0';
            }
            left = eval(expTree.getLeft());
            right = eval(expTree.getRight());
            return computeVal(right, left,(Character) expTree.getValue());
        }
        return -1;
    }
     ...
     */
    public static int computeVal(Integer op1, Integer op2, char operator)
    {
        if (operator == '+')
        {
            return (op1 + op2);
     ...
     * optional work
     */
    public static TreeNode createExpressionTree(String exp) // return type should be TreeNode
    {
        //throw new RuntimeException("Write ME!");
     ...
     * @param expression valid expression in infix form
    ...
    public static int getPrec(char operator)
    {
