...
public class BinaryTreeTester
{
    ...
    private void expressionTest()
    {
        ...
        System.out.println("ENTER EXPRESSION BELOW (WITH SPACES BETWEEN EVERY CHARACTER): ");
    ...
    public void test()
    {
            ...
            try
            {
                if (!alreadyHappened) 
                {
                    System.out.println ("\fWelcome to the Binary Tree Tester.\n" + 
                        ...
                        "methods, 3 to test Save and Read to and from a File, 4 to test expression trees, and 5 to quit.");
                }
                else
                {
                    System.out.println ("\fInvalid input, please try again.\n\n" + 
                        "Enter 1 to test basic tree methods, " + 
                        "2 for morse code methods, 3 to test Save and Read to and from a File, 4 to test expression trees, and 5 to quit.");
                }
        ...
        while (true)
        {
            ...
            if (response == 4) {expressionTest();}
            if (response == 5) {System.out.print("\f Exited."); System.exit(1);}
